<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="purchaseorderviewLargeModalLabel{{ $Sale_Delivery_Datas['unique_key'] }}">Sales Details</h5>
                           ...
                           <div class="invoice-item invoice-item-date card py-2 " style="background: #751818;">
                              <div class="row ">
                                 <div class="col-md-3">
                                    ...
                                    Bill No<span>: </span><strong style="color:white;"># {{ $Sale_Delivery_Datas['bill_no'] }}</strong>
                                    </p>
                                 </div>
                                 <div class="col-md-3">
                                    <p class="invoice-details" style="color:white;">
                                       Customer<span>: </span><strong style="color:white;text-transform: uppercase;">{{ $Sale_Delivery_Datas['customer'] }}</strong>
                                    </p>
                                 </div>
                                 <div class="col-md-3">
                                    <p class="text-start invoice-details" style="color:white;">
                                       Date<span>: </span><strong style="color:white;">{{ date('d-m-Y', strtotime($Sale_Delivery_Datas['saledate'])) }}</strong>
                                    </p>
                                 </div>
                                 <div class="col-md-3">
                                    <p class="text-start invoice-details" style="color:white;">
                                       Bank<span>: </span><strong style="color:white;">{{ $Sale_Delivery_Datas['payment_method'] }}</strong>
                                    </p>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="invoice-box " style="max-width: 1600px;width:100%;padding: 0;font-size: 14px;line-height: 24px;color: #555;">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-10 col-10  col-sm-11">
                           ...
                           <div class="row ">
                              @if ($Sale_Delivery_Datas['terms'])
                                 @foreach ($Sale_Delivery_Datas['terms'] as $index => $term_arr)
                                    @if ($term_arr['sales_id'] == $Sale_Delivery_Datas['deliverysale_id'])
                                       <div class="col-lg-3 col-sm-3 col-12 border">
                  ...
                  <div class="col-lg-6  py-2">
                     <div class="total-order w-100 max-widthauto mb-4">
                        <ul>
                           <li class="total">
                              <h4>Sub Total</h4>
                              <h5 class="">₹ <span  class="">{{ $Sale_Delivery_Datas['sub_total'] }}</span></h5>
                           </li>
                           <li class="total">
                              <h4>Discount Price</h4>
                              <h5>₹ <span  class="">{{ $Sale_Delivery_Datas['sale_discount'] }}</span></h5>
                           </li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-lg-6  py-2">
                     <div class="total-order w-100 max-widthauto mb-4">
                        <ul>
                           <li class="total">
                              <h4>Grand Total</h4>
                              <h5 style="color:green">₹ <span  class="">{{ $Sale_Delivery_Datas['grandtotal'] }}</span></h5>
                           </li>
                        </ul>
                     </div>
                     </div>
